...
<template>
  <section class="ranking">
    ...
    <ol class="aggregation-mode-list">
      <li class="aggregation-mode-list-item" v-for="(mode, index) in Object.values(AggregationType)" :key="mode">
        <input type="radio" name="aggregation-mode" :value="index" v-model="selectedType">
    ...
    <ol class="ranking-mode-list">
      <li class="ranking-mode-list-item" v-for="(mode, index) in Object.values(RankType)" :key="mode">
    ...
    <ol class="ranking-list">
      <li class="ranking-list-item" v-for="(ranker, index) in rankers" :key="ranker.nsaid">
        <div class="ranking-list-header">
          <span class="rank">{{ index + 1 }}</span><span class="score">{{ ranker.count }}</span><span
            class="team-id">ID: {{ ranker.nsaid }}</span>
        </div>
          ...
          <li class="member-list-item">
            <RouterLink :to="`/users/${ranker.nsaid}`">
              <a class="internal-link" href="">
                <div>
                  <img class="thumbnail-image" :src="ranker.thumbnail_url" alt="Ranker thumbnail URL" />
                </div>
              </a>
            </RouterLink>
